...
export default function Editor({ initialValue = '', onChange, initialTitle = '' }) {
  ...
  return (
    <div className="flex justify-center">
      <div className="font-[family-name:var(--font-geist-mono)] antialiased prose w-full max-w-prose">
        <h1 className="text-2xl font-bold mb-4" contentEditable suppressContentEditableWarning>{initialTitle}</h1>
        <div
          ref={divRef}
          contentEditable
